...
│   ├── 03_train_adversarial.ipynb
│   └── 04_train_standard.ipynb
├── src/
...
3. **03_train_adversarial.ipynb** — Adversarial training for transformer models
4. **04_train_standard.ipynb** — Standard training for transformer models
